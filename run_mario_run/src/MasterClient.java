...
public class MasterClient extends Thread{
    ...
    public MasterClient(Socket request,int workers,String [] addresses){
...
//            }
            ...
            FileWriter fileOutputStream = new FileWriter(gpxFile);
...
//            System.out.println(f);
            ...
            List<List<Waypoint>> list = RandomChunks(WaypointList,numOfWorkers);
            ...
            try{
                ...
                ////android from here to
                String all = map2.toString() + "\n"+mapUserFinal.toString()+"\n"+mapUserFinalStats.toString();
                out.writeUTF(all);
                out.flush();
                /////here
...
//                }
                ...
                System.out.println("STATS_FOR_FILE"+map2.toString());
                System.out.println("STATS_FOR_USERS"+mapUser.toString());
...
//        }
        ...
        try {
            ...
            while(true){
                ...
                Thread t = new MasterClient(socket,workers,addresses);
                t.start();
            }
        } catch (IOException e) {
            e.printStackTrace();
